...
function NativeTransactions() {
  ...
  const { getNFTTransactionsForContract } = useCovalent();
  const { Moralis } = useMoralis();

  const getNFTTransactions = (tokenId) => {
    const ca = '0x869C7616a7CE7C1F4C4e21b59e3eB145cab72617';
    getNFTTransactionsForContract(ca, tokenId)
  }

  //get tx with covalent
  getNFTTransactions(1);
  //
